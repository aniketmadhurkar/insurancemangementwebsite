        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header bg-primary  d-flex">
                    <h4 class="header-title  text-white">Rejected Policies</h4>
...
inner join categories on subcategories.category_id=categories.category_id WHERE customer_policies.status='Rejected' " ;
