        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header bg-primary  d-flex">
                    <h4 class="header-title  text-white">Pending Policies</h4>
...
inner join categories on subcategories.category_id=categories.category_id WHERE customer_policies.status='Pending' " ;
...
$i++;
        ...
        <td>' . $row["tenure"] . '</td> 
        <td>' . $row["status"] . '</td> 
    <td><a href="pendingupdate.php?id=' . $row["customer_policy_id"] . '&pid=' . $row["policy_id"] . '&cid=' . $row["customer_id"] . '" id="btnApply" class="btn btn-sm btn-outline-primary" value="Apply" 
    >Update Status </a>&nbsp;&nbsp;
